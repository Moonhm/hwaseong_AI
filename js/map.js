...
function buildOverlays() {
  /* 폴백 좌표(37.199,126.831)에 겹친 축제 18건이 있어
     — 주소가 실제로 「미정」인 것은 16건이고, 나머지 2건(id 90·128)은
     장소명이 있는데 지오코딩이 안 된 것이다(2026-09-03 재실측). id:128 은 화성시청이라 폴백이 정답이고,
     id:90 은 주소가 「크리스찬교회(예정)」이라 확정 전에는 좌표를 박지 않는다.
     원래 21건 · 나머지 5건(id 90·103·106·107·128)이었는데, 배포 Claude 가 장소명이 확실한
     103·106·107 을 지오코딩해 빠졌다(2026-09-02, `be52c78`).
