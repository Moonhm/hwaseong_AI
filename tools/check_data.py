...
CEILING = {
    ...
    # 2026-08-27: 34 → 0. 사용자가 관광지 사진 33장을 한 번에 줘서
    # **tourist 151곳 전건이 사진을 갖게 됐다**(festival 50·heritage 42도 전건).
    # 0 이므로 이제 한 장이라도 사라지면 즉시 FAIL 이다 — 그게 맞다.
    # 사진을 지워야 할 사정이 생기면 그때 근거와 함께 올려라.
    "photo_missing_tourist": 0,
