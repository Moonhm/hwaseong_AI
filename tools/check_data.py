...
CEILING = {
    ...
    # 2026-08-27: 34 → 28. 사용자가 관광지 사진 5장을 새로 줬다
    # (금당 엄나무마을·돌샘터 체험농장_우정승마장·새싹동산 청려수련원·
    #  장전 노루마을·청미르 휴양마을). 상한을 안 내리면 다음에 사진이
    # 사라져도 28~34 구간에서는 검사가 잡지 못한다.
    "photo_missing_tourist": 28,
