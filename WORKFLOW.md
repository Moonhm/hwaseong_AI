...
| 개발 Claude | `index.html` · `js/map.js` · `js/conv_map.js` · `js/parking.js` · `js/localcurrency.js` · `css/` · `tools/server.py` |
...
(`js/map.js:389`, `index.html:2014·2322·3041` — 가공 없이 문자열을 그대로 이어붙입니다).
